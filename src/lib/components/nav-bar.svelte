<script lang="ts">
  ...
  const services = $state([
    ...
    },
    {
      title: "AI Driven",
      description:
        "AI-driven solutions to automate, optimise, and scale your business.",
      icon: ServiceAi,
    ...
    },
    {
      title: "Shopify",
      description:
        "Shopify solutions for seamless store management, automation, & growth.",
      icon: ServiceShopify,
...
<nav
  class="flex items-center justify-between bg-white p-4 shadow md:justify-around md:p-0 sticky top-0 z-50"
>
                ...
                <ul class="mt-2 ml-4 space-y-2">
                  {#each services as service}
                    <li>
                      ...
                      >
                        <div class="flex items-center gap-3">
                            <service.icon width={20} height={20}   />
