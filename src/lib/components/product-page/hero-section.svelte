  ...
  <div class="px-6 max-w-7xl mt-7 lg:mt-24 w-full">
    <div class="flex flex-col lg:flex-row lg:items-center lg:gap-12">
      <div class="lg:w-1/2 flex flex-col justify-center lg:order-1">
        ...
        >
          Our Product Engineering Services are designed to bring your ideas to
          life, from concept to deployment. We specialize in developing
          scalable, high-performance solutions tailored to your business needs,
          leveraging cutting-edge technologies and agile methodologies. Partner
          with us to accelerate innovation, enhance user experiences, and
