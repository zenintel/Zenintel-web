...
type Highlighter = (code: string, lang: string | null | undefined, metastring: string | null | undefined, filename?: string, optimise?: boolean) => string | Promise<string>;
...
type PreprocessorReturn = Promise<{
    code: string;
 ...
 * - `rehypePlugins` - rehype plugins to apply to the rendered html
 */
declare const _compile: (source: string, opts?: MdsvexCompileOptions) => Promise<PreprocessorReturn>;
