...
const code_highlight = async (
	...
	//@ts-ignore
	if (!Prism) Prism = await import('./prism-Thd-V7xt.js').then(function (n) { return n.p; });
...
const mdsvex = (options = defaults) => {
	...
	let layouts_processed = undefined;
...
export { _compile as _, code_highlight as a, commonjsGlobal as c, defineConfig as d, escape_svelty as e, getDefaultExportFromCjs as g, mdsvex as m };
//# sourceMappingURL=main-hjyl9aFB.js.map
